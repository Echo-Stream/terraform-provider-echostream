...
func (d *LogEmitterNodeDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *LogEmitterNodeDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	echoResp, err := api.ReadNode(ctx, d.data.Client, "Log Emitter", d.data.Tenant)
	if err != nil {
